...
def runStyleConsensusLearning(num_epochs=1, batch_size=1, isImage_=True, model_type='vgg'):
    ...
    model_SLAE = torch.load('/home/cuijia1247/Codes/style-consensus-learning/temp/2025-04-03-07-45-07_69.53781512605042_1770_SCL.pth')
    ...
    #     # nn.ReLU(),
    # ).cuda()
    model_classifier = torch.load('/home/cuijia1247/Codes/style-consensus-learning/temp/2025-04-03-07-45-07_69.53781512605042_1770_CLS.pth')
...
def sscae_style_predict_and_return(img_path, model_SSCAE, model_classifier, model_type='vgg'):
    ...
    if model_type == 'vgg':
        ...
        feature_sty = feature_sty.reshape(1, 32, 56, 56)  # special for resnet50
    # level1 = np.reshape(level1, (img.shape[0], 32, 56, 56))  # special for resnet50
...
def output_CTRL_reference_label(source_folder, label_path, output_file, model_type='vgg'):
    correct = 0
    count = 0
    ...
    model_SSCAE = torch.load('/home/cuijia1247/Codes/style-consensus-learning/data/WikiArt3/50.43/2025-04-07-15-15-19_50.43731778425656_362_SCL.pth')
    # model_classifier = nn.Sequential(
    ...
    #     # nn.ReLU(),
    # ).cuda()
    model_classifier = torch.load('/home/cuijia1247/Codes/style-consensus-learning/data/WikiArt3/50.43/2025-04-07-15-15-19_50.43731778425656_362_CLS.pth')
    ...
    with open(output_file, 'w', encoding='utf-8') as w:
        ...
        for root, dirs, files in os.walk(source_folder):
            for file in tqdm.tqdm(files):
                ...
                pre_ = sscae_style_predict_and_return(img_path, model_SSCAE, model_classifier, model_type)
...
if __name__ == '__main__':
    ...
    output_CTRL_reference_label(source_folder, label_path, output_file, model_type='resnet')
