...
def runStyleConsensusLearning(num_epochs=1, batch_size=1, isImage_=True, isLeveled_=False, Levels_=4):
    ...
    model_SLAE.load_state_dict(torch.load('/home/cuijia1247/Codes/style-consensus-learning/paper_data/vgg16/FashionStyle14-train-2024-02-10-22-59-57_99.1246234939759_64_SCL/2024-02-10-22-59-57_99.1246234939759_64_SCL.pth'))
    ...
    model_classifier.load_state_dict(torch.load('/home/cuijia1247/Codes/style-consensus-learning/paper_data/vgg16/FashionStyle14-train-2024-02-10-22-59-57_99.1246234939759_64_SCL/2024-02-10-22-59-57_99.1246234939759_64_CLS.pth'))
    ...
    for epoch in range(num_epochs):
        for i, (img, label, level, img_name, level1) in enumerate(dataloader):
            ...
            features, _ = model_SLAE(img, level1, 0, 0, 0)# without l2, l3
