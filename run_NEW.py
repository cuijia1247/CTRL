...
def runStyleConsensusLearning(num_epochs=3000, batch_size=256, isImage_=True, model_type='vgg'):
    ...
    dataset = TCFLDataset(
                                ...
                                ### webstyle
                                labelFile='./data/webstyle/Labels/train.txt',
                                featureName='./features/webstyle20250421_ds_resnet50_train.npy',  # painting91
                                # featureName='./features/painting91_resnet50_train.npy',  #painting91
                                imageFolder='./data/webstyle/webstyle/Images/',
    ...
    val_dataset = TCFLDataset(
                                ...
                                ### webstyle
                                labelFile='./data/webstyle/Labels/test.txt',
                                featureName='./features/webstyle20250421_ds_resnet50_test.npy', #painting91
                                # featureName='./features/painting91_resnet50_test.npy',  # painting91
                                imageFolder='./data/webstyle/Labels/Images/',
    ...
    if model_type == 'vgg':
        layernum = [8, 256, 256, 512]  # for vgg16
    else:
    ...
    with open('features/webstyle20250421_ds_resnet50_train.pkl', 'rb') as pickle_f:
    #####################################
    # with open('features/webstyle_ds_resnet50_train.pkl', 'rb') as pickle_f:
        styleSet = pickle.load(pickle_f)
    for epoch in range(num_epochs):
        print('epoch is {}'.format(epoch))
        if epoch % 200 == 0: #origianl
        # if epoch == 0: #classifier do not initilization
            ...
            #  vgg vs. resnet manual change!!!!!!!
            classifier = nn.Sequential(
                nn.Linear(32 * 3136, 512),  # for resnet50
...
if __name__ == '__main__':
    ...
    # batch_size = 128
    isImage = False
    runStyleConsensusLearning(isImage_=isImage, model_type='resnet')
