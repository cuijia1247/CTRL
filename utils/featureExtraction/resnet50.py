...
if __name__ == '__main__':
    model = make_models()
    imgPath = './data/webstyle/Images'
    labelPath = './data/webstyle/Labels/test.txt'
    featurePath = './features'
    featureName = 'webstyle20250421_ds_resnet50_test.npy'
    featureE(model, imgPath, labelPath, featurePath, featureName)
    # imgPath = '../../data/webstyle/subImages/test/'
    # targetPath = '../../features/'
    # featureName = 'webstyle20250421_ds_resnet50_test.pkl'
    # styleDataset(model, imgPath, targetPath, featureName, 10)